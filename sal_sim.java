...
public sal_sim(int numind, int numloci, int numchr, int diffSex, int sal) {
	nind = numind;
	nloci = numloci;
	nchr = numchr;
	diff_sex = diffSex;
...
public static void main(String[] args) throws Exception{
	...
	sal_sim output = new sal_sim(30, 100, 10, 1, 10);
	...
	List<List<String>> anno_file = output.anno_file();
	write_to_file(geno_file);
	write_pheno_file(phenotypes);
	write_anno_file(anno_file);
